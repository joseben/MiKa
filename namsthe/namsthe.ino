...

{
    ...
    for (BIcep_Up_pos=5; BIcep_Up_pos <=60; BIcep_Up_pos += 1) { // goes from 0 degrees to 180 degrees
          // in steps of 1 degree
...

{
    ...
    for (BIcep_Up_pos=60; BIcep_Up_pos >=5; BIcep_Up_pos -= 1) { // goes from 0 degrees to 180 degrees
          // in steps of 1 degree
          L_BIcep_Up.write(BIcep_Up_pos);              // tell servo to go to position in variable 'pos'
          R_BIcep_Up.write(BIcep_Up_pos);              // tell servo to go to position in variable 'pos'

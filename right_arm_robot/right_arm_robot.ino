...
{    
  ...
  for (Shld_Rot_Pos=0; Shld_Rot_Pos <=50; Shld_Rot_Pos += 1) { // goes from 0 degrees to 180 degrees
...

{
    ...
    for (BIcep_Up_pos; BIcep_Up_pos <=85; BIcep_Up_pos += 1) { // goes from 0 degrees to 180 degrees
          // in steps of 1 degree
...

{
    ...
    for (BIcep_Up_pos; BIcep_Up_pos >=10; BIcep_Up_pos -= 1) { // goes from 0 degrees to 180 degrees
          // in steps of 1 degree
          BIcep_Up.write(BIcep_Up_pos);              // tell servo to go to position in variable 'pos'
          delay(15);                       // waits 15ms for the servo to reach the position
          }
